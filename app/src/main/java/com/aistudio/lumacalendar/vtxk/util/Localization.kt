...
data class AppStrings(
    ...
    val snoozeDurationTitle: String,
    val snoozeDurationDesc: String,
    val notificationDailyMsgEmpty: String,
    ...
    companion object {
        val Persian = AppStrings(
            ...
            snoozeDurationTitle = "مدت یادآوری",
            snoozeDurationDesc = "مدت زمان پیش‌فرض برای به تعویق انداختن اعلان: 15m، 30m، 1h، 2h، 4h، 8h",
            notificationDailyMsgEmpty = "✨ امروز روز خوبی برای برنامه‌های مهمه",
            ...
            resetConfirmTitle = "بازنشانی اطلاعات نمونه؟",
            resetConfirmMessage = "رویدادهای فعلی شما با داده‌های نمونه جایگزین می‌شوند و این عمل قابل بازگشت نیست.",
            resetConfirmAction = "بازنشانی",
            clearConfirmTitle = "پاک کردن تمام رویدادها؟",
            clearConfirmMessage = "تمام رویدادهای ذخیره‌شده برای همیشه حذف می‌شوند و این عمل قابل بازگشت نیست.",
            clearConfirmAction = "پاک کردن",
        ...
        val English = AppStrings(
            ...
            snoozeDurationDesc = "Default snooze time when reminding later: 15m, 30m, 1h, 2h, 4h or 8h",
            notificationDailyMsgEmpty = "✨ Today is a great day for what matters most",
            ...
            resetConfirmTitle = "Reset sample data?",
            resetConfirmMessage = "Your current events will be replaced with the sample schedule. This cannot be undone.",
            resetConfirmAction = "Reset",
            clearConfirmTitle = "Clear all data?",
            clearConfirmMessage = "Every saved event will be permanently deleted. This cannot be undone.",
